...
            // ===== FIX: Added `submitted_at` to the query to fix the "N/A" date on the vendor dashboard =====
...
            // ===== FIX 1: Wrapped the subquery in COALESCE to prevent "undefined items" issue =====
...
            // ===== FIX 2: Changed to LEFT JOIN and improved WHERE clause to prevent 'null' in chart labels =====
